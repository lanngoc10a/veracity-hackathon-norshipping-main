...
for ship in ships:
    for avg_speed in range(6,15):
        valid_data=send_http_get_request(build_get_vessel_parameters( imo=ship["IMO"], avg_speed_kn=avg_speed, duration_h=24, load_cond="ballast", distance_nm=240), header) 
        result_table.append(valid_data)
